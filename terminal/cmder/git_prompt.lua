...
-- specifically for git (getting the local and remote branches)
-- C:\Users\<User>\Downloads\cmder_mini\vendor\clink-completions\git_prompt.lua
-- and modified (remote refs)
